...
public class LocalDateUtils {
     ...
     * 获取当前日期和时间的字符串
     *
     * @return String 日期时间字符串 例如: 2015-8-11 9:51:53
     */
     ...
     * 获取当前日期字符串
     *
     * @return String   日期字符串,例如2015-8- 11
     */
     ...
     * 获取当前时间字符串
     *
     * @return String 时间字符串， 例如 9:51：53
     */
    ...
    public static String getDayOfWeekStr(LocalDate localDate) {
        ...
        int dayOfWeeks = localDate.getDayOfWeek().getValue() - 1;
        return weekOfDays[dayOfWeeks];
    }
